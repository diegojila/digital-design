...
const disciplines = [
  { title: 'marca', label: 'Brand strategy & identity', description: 'Una marca con un punto de vista claro, lista para hacerse notar y crecer.', palette: 'acid' },
  ...
  { title: 'campaña', label: 'Campaigns & art direction', description: 'Campañas que hacen que una buena idea llegue más lejos y deje huella.', palette: 'coral' },
...
function App() {
  ...
  return <main className={`page palette--${discipline.palette}`}>
    ...
    <section className="work section" id="work" aria-labelledby="work-title">
      <div className="section-heading"><h2 id="work-title">Diseño que pone a las empresas a la altura de su ambición.</h2><p>Identidades, plataformas digitales y campañas convertidas en señales claras para destacar, conectar y seguir creciendo.</p></div>
    ...
    <section className="contact section" id="contact" aria-labelledby="contact-title">
      <div className="contact-intro"><p className="section-label">Start something / 2026</p><h2 id="contact-title">Tu siguiente etapa empieza con una buena conversación.</h2><p>Solicita un presupuesto sin compromiso. Cuéntame qué necesitas y recibirás una primera respuesta por email en un máximo de dos días laborables.</p></div>
